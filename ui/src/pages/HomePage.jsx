  ...
  return (
    <>
      ...
      <section className="section">
        ...
        <div className="grid">
          <Card title="Pokemon Dex" subtitle="Find stats fast.">
            <p>
              Browse Pokemon lists, abilities, and elements in a structured way
              so you can pick a strong team core. All access is free.
            </p>
      ...
      <section className="section split-section">
        ...
        <div className="steps">
          <Card title="1. Explore data" subtitle="Find Pokemon and types.">
            <p>
              Use the Pokemon menu to check stats, types, and strengths for each
              character.
            </p>
          </Card>
      ...
      <section className="cta-section">
        ...
        >
          <p>
            PokeLab is ready to guide your journey. Check data or start building
            your team right now. No subscriptions required.
          </p>
          <div className="cta-row">
